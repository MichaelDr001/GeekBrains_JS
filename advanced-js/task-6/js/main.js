...
// Поиск не отображается, не знаю почему.
// Если поменять form на div - то же самое.

Vue.component('search-container', {
    template: `
        <form class= "seach_form" action="">
        <input class="search_input" v-model="searchInput" type="search" required>
            <i class="fa fa-search" v-on:click="searchProducts"></i>
            <a class="clear_search" href="javascript:void(0)" id="clear-btn">Clear</a>
        </form>
    `
});


// Пробросом содержимого тоже пробовал.
// Пример ниже.
...
// Vue.component('search-container', {
//     template: `
//         <form class= "seach_form" action=""><slot></slot></form>
//     `
// });
